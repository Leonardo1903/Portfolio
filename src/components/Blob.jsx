    ...
    <div className="relative flex items-center justify-center w-full h-full">
      ...
      <div className="relative z-10 flex items-center justify-center">
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute inset-0 rounded-full bg-gradient-to-r from-red-500 to-amber-500 blur-md opacity-60"></div>

          <img
            src={Profile.src ? Profile.src : Profile}
            alt="Profile"
            className="relative w-40 h-40 xs:w-56 xs:h-56 md:w-[400px] md:h-[400px] rounded-full object-cover border-4 border-[#FF4C29] shadow-[0_0_32px_0_rgba(255,76,41,0.25)]"
          />
        </motion.div>
      </div>
    </div>
